    ...
    return (
        <div className='h-screen w-full flex items-center justify-center dark:bg-[#0c0a1a]'>
            <motion.div
                ...
                className={`bg-white rounded-lg shadow-lg ${isLargeScreen ? 'w-[80%]' : 'w-full'} h-full flex flex-col md:flex-row overflow-hidden dark:bg-transparent dark:border dark:border-[#c2a7fb]/20`}
            >
                {isLargeScreen && (
                    <div className="relative overflow-hidden w-full">
                        <div className="absolute inset-0 bg-black/5 dark:bg-black/15 z-10"></div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='space-y-4 flex w-full flex-col items-center'>
                        <div className={`w-full ${isLargeScreen ? '' : 'max-w-96'}`}>
                            ...
                            <input
                                ...
                                className='w-full p-3 border rounded dark:border-[#2a283a] dark:bg-[#13111d] dark:text-purple-100 focus:outline-none focus:ring-1 focus:ring-[#6229b3] transition-colors'
                            />
                        ...
                        <div className={`w-full ${isLargeScreen ? '' : 'max-w-96'}`}>
                            ...
                            <div className='relative'>
                                <input
                                    ...
                                    className='w-full p-3 border rounded pr-12 dark:border-[#2a283a] dark:bg-[#13111d] dark:text-purple-100 focus:outline-none focus:ring-1 focus:ring-[#6229b3] transition-colors'
                                />
                                <button
                                    type='button'
                        ...
                        <div className={`w-full ${isLargeScreen ? '' : 'max-w-96'} flex items-start`}>
                            <input
                                ...
                                className='mr-2 mt-1'
                            />
                            <label className='text-sm dark:text-purple-200/90'>
                                By creating an account, you agree to our <a href='/terms' className='text-[#4c1f8e] dark:text-[#c2a7fb] underline hover:text-[#6229b3] dark:hover:text-[#c2a7fb]/80'>Terms of Service</a> and <a href='/privacy' className='text-[#4c1f8e] dark:text-[#c2a7fb] underline hover:text-[#6229b3] dark:hover:text-[#c2a7fb]/80'>Privacy Policy</a>.
                            </label>
                        </div>
