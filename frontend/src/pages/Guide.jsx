...
const Guide = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-b rounded-t-lg from-gray-900 to-[#4c1f8e] text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <motion.section 
          ...
          {...fadeIn}
        >
          <h2 className="text-3xl font-bold text-[#4c1f8e] mb-8 flex items-center">
        ...
        {/* Coming Soon Section */}
        <motion.section 
          className="mb-16 bg-white rounded-xl p-8 shadow-md border border-purple-100"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.3 }}
        >
          <h2 className="text-2xl font-bold text-[#6229b3] mb-6">🚀 Coming Soon...</h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            <div className="border border-gray-100 rounded-lg p-5 bg-gray-50">
              <div className="flex items-center text-[#6229b3] mb-3">
                <FaVideo className="text-2xl mr-3" />
                <h3 className="font-semibold">Video Call</h3>
              </div>
              <p className="text-sm text-gray-600">One-click video calls within a project workspace.</p>
            </div>
            ...
            <div className="border border-gray-100 rounded-lg p-5 bg-gray-50">
              ...
              <p className="text-sm text-gray-600">Share your screen with team members during discussions.</p>
            </div>
            ...
            <div className="border border-gray-100 rounded-lg p-5 bg-gray-50">
              ...
              <p className="text-sm text-gray-600">See how your productivity trends over time. (Optional)</p>
            </div>
          </div>
        </motion.section>
        ...
        >
          <h2 className="text-2xl font-bold text-[#6229b3] mb-6 flex items-center">
        ...
        >
          ...
          <p className="mb-6 text-gray-600 text-lg">Once inside a project, your workspace nav bar unlocks access to:</p>
          
          <div className="overflow-x-auto">
            <table className="w-full text-left text-base">
              <thead>
                <tr className="bg-gray-50">
                  <th className="px-4 py-3 border-b-2 border-gray-200 text-lg">Tab</th>
                  <th className="px-4 py-3 border-b-2 border-gray-200 text-lg">Purpose</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="px-4 py-4 border-b border-gray-100 font-medium flex items-center">
                    <FaRegComments className="text-xl text-[#6229b3] mr-2" /> Chat
                  </td>
                  <td className="px-4 py-4 border-b border-gray-100 text-gray-600 text-base">Real-time chat with your team.</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 border-b border-gray-100 font-medium flex items-center">
                    <FaRegListAlt className="text-xl text-[#6229b3] mr-2" /> Todos
                  </td>
                  <td className="px-4 py-4 border-b border-gray-100 text-gray-600 text-base">Add, update, and track tasks.</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 border-b border-gray-100 font-medium flex items-center">
                    <FaRegClock className="text-xl text-[#6229b3] mr-2" /> Logs
                  </td>
                  <td className="px-4 py-4 border-b border-gray-100 text-gray-600 text-base">View project activity & task history.</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 border-b border-gray-100 font-medium flex items-center">
                    <FaUserFriends className="text-xl text-[#6229b3] mr-2" /> Collaborators
                  </td>
                  <td className="px-4 py-4 border-b border-gray-100 text-gray-600 text-base">Manage who has access and roles in the project.</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 font-medium flex items-center">
                    <FaRegFileAlt className="text-xl text-[#6229b3] mr-2" /> About
                  </td>
                  <td className="px-4 py-4 text-gray-600 text-base">Add SRS docs, GitHub repos, hosted links and project notes.</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        {/* Help Section */}
        <motion.section 
          className="mb-8 bg-gradient-to-r from-purple-50 to-white p-8 rounded-xl shadow-sm border border-purple-100"
          {...fadeIn}
        ...
        >
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              <span className="text-[#6229b3] mr-2">•</span>
              <span>Email: <a href="mailto:support@todoshi.app" className="text-[#6229b3] hover:underline">support@todoshi.app</a></span>
            </li>
            <li className="flex items-start">
              <span className="text-[#6229b3] mr-2">•</span>
          ...
          <div className="mt-8 text-center">
            <p className="flex items-center justify-center text-[#6229b3]">
              <FaHeart className="mr-2" /> Thank you for choosing Todoshi.
            </p>
            <p className="text-gray-600">Let's build, ship, and get things done — together.</p>
          </div>
        </motion.section>
      </div>
    </div>
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
    <div className="text-[#6229b3] text-2xl mb-3">{icon}</div>
...
const StepCard = ({ number, title, items, isLast = false }) => (
  <div className={`relative pl-12 ${!isLast ? 'pb-8' : ''}`}>
    {!isLast && <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-purple-100"></div>}
